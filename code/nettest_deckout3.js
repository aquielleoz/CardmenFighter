...
const DIR=__dirname,PORT=+(process.env.PORT||8319),ROOM='DO'+Date.now().toString().slice(-3);
...
const lead=(p,id)=>selectAndFight(p, [id]);                 // two-state button since epic step 20 — see fightclick.js
