...
(async()=>{
  ...
  // Stage: c1 holds Critical Hit (9S) + ample ♠ energy; host & c2 plain (no counters). Everyone at 4 shields.
  ...
  await host.evaluate((a)=>window.__cmf.forceAll(a.hands, a.en, a.sh), {
    hands:[[D(2,'C',"h0"),D(3,'C',"h0"),D(6,'H',"h0")], [D(9,'S'),D(7,'C',"h1"),D(8,'H',"h1")], [D(2,'D',"h2"),D(3,'H',"h2"),D(4,'C',"h2")]],
    en:[[],spade(),[]], sh:[4,4,4]
  });
  await wait(500);
