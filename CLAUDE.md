...
npm test               # = node test.js && node netview.test.js — 520 + 65 assertions, must end 0 FAIL
...
node test.js                                    # engine + AI suite — 520 assertions, must end 0 FAIL
...
node lessontest_howto.js                # the "How to Play" lesson — 10 steps, 3 gated (26)
...
`versiontest` 30, `sharetest` 17, `qrtest` 32, `peektest` 43, `logtest` 21, `motiontest` 7, `phonetest` 72, `oppbeatstest` 8, `counterfeittest` 11, `quicktest` 6, `shadowtest` 7, `prompttest` 25, `resolutiontest` 16, `resolutiontest_ui` 33, `lessontest_quicks` 21, `lessontest_howto` 26,
