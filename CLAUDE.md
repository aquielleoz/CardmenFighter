...
node mptest.js                                  # free-for-all parity: pre-fight, responses, zones, presentation, targeting, naming (88)
...
`test` 504, `netview` 65, `mptest` 88, `rulestest` 150, `landscapetest` 192, `decktest` 42, `viewtest` 21,
