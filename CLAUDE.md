...
npm test               # = node test.js && node netview.test.js — 393 + 55 assertions, must end 0 FAIL
...
node netview.test.js                            # netplay snapshot redaction + the mirror contract — 55, must end 0 FAIL
