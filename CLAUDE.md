...
Current version: **v1.31.103**. Read [`docs/NEXT-SESSION.md`](docs/NEXT-SESSION.md) first — it is the live
...
Status as of **v1.31.103 — 2026-09-04, `npm run sweep`, 82 suites and 0 FAIL in 175s** (four lanes; background
...
`versiontest` 26, `sharetest` 16, `qrtest` 32, `peektest` 41, `logtest` 18, `motiontest` 7, `phonetest` 19, `lessontest_quicks` 21, `lessontest_howto` 24,
