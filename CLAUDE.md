...
npm test               # = node test.js && node netview.test.js — 416 + 64 assertions, must end 0 FAIL
...
node test.js                                    # engine + AI suite — 416 assertions, must end 0 FAIL
...
`test` 416, `netview` 64, `mptest` 85, `rulestest` 150, `landscapetest` 192, `decktest` 42, `viewtest` 21,
