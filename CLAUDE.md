...
npm test               # = node test.js && node netview.test.js — 406 + 63 assertions, must end 0 FAIL
...
node test.js                                    # engine + AI suite — 406 assertions, must end 0 FAIL
...
`test` 406, `netview` 63, `mptest` 85, `rulestest` 150, `landscapetest` 192, `decktest` 42, `viewtest` 21,
