...
npm test               # = node test.js && node netview.test.js — 488 + 65 assertions, must end 0 FAIL
...
node test.js                                    # engine + AI suite — 488 assertions, must end 0 FAIL
...
`test` 488, `netview` 65, `mptest` 85, `rulestest` 150, `landscapetest` 192, `decktest` 42, `viewtest` 21,
