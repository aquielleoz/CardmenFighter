...
npm test               # = node test.js && node netview.test.js — 529 + 65 assertions, must end 0 FAIL
...
node test.js                                    # engine + AI suite — 529 assertions, must end 0 FAIL
...
`test` 529, `netview` 65, `mptest` 93, `rulestest` 150, `landscapetest` 192, `decktest` 42, `viewtest` 25,
